...
<head>
    ...
    <title>Policy Admin Login</title>
...
<body>
	 <section class="top-section">
        ...
        <header class="header">
            ...
            <ul>
                ...
                <li> <a href="policyadminregister"> Sign up </a>
                </li>
                <li> <a href="policyadminlogin"> Sign in </a>
                </li>
            </ul>
        </header>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${mode=='mode_policyadminregister'}">
                                    <form action="policyadminsave-user" class="register-form" method="POST">
                                        ...
                                        <div class="alignment">
                                            <input type="hidden" value="PolicyAdmin" name="category"
                                                path="${user.category}" />
                                        ...
                                        <p class="message">Existing User? <span><a href="policyadminlogin"
                                ...
                                <c:when test="${mode=='mode_policyadminregistered'}">
                                    <h3>Your PolicyAdmin Registration was succesfully Completed</h3>
                                ...
                                <c:when test="${mode=='mode_policyadminlogin'}">
                                    <form action="policyadminloginuser" method="POST">
                                        ...
                                        <input type="submit" name="submit" class="sub btn btn-success mb-3"
                                            value="Log in">
                                        <p class="message">Not Registered? <span><a href="policyadminregister"
                                                    style="text-decoration: none;">Register</a></span></p>
                                                    <p class="message">Forgot Password? <span><a href="policyforgotpassword1"
    ...
    <form action="policyupdatepassword" method="POST">
