    ...
    <section class="top-section">
        ...
        <header class="header">
            ...
            <ul>
                ...
                <li> <a href="customerregister"> Sign up </a>
                </li>
                <li> <a href="customerlogin"> Sign in </a>
                </li>
            </ul>
        </header>
                            ...
                            <c:choose>
                                <c:when test="${mode=='mode_customerregister'}">
                                    <form action="customersave-user" class="register-form" method="POST">
                                        ...
                                        <input type="hidden" name="policyreq" value="false" path="${user.policyreq}" />
							<input type="hidden" name="policyaccept" value="false" path="${user.policyaccept}" />
							<input type="hidden" name="ad_to_fo" value="false" path="${user.ad_to_fo}" />
							<input type="hidden" name="fo_to_adac" value="false" path="${user.fo_to_adac}" />
							<input type="hidden" name="fo_to_adrej" value="false" path="${user.fo_to_adrej}" />
							<input type="hidden" name="ad_to_po" value="false" path="${user.ad_to_po}" />
							<input type="hidden" name="po_to_adac" value="false" path="${user.po_to_adac}" />
							<input type="hidden" name="po_to_adrej" value="false" path="${user.po_to_adrej}" />
                                        <div class="alignment">
                                        ...
                                        <p class="message">Existing User? <span><a href="customerlogin"
                                ...
                                <c:when test="${mode=='mode_customerregistered'}">
                                    <h3>Your Customer Registration was succesfully Completed</h3>
                                ...
                                <c:when test="${mode=='mode_customerlogin'}">
                                    <form action="customerloginuser" method="POST">
                                        ...
                                        <input type="submit" name="submit" class="sub btn btn-success mb-3"
                                            value="Log in">
                                        <p class="message">Not Registered? <span><a href="customerregister"
                                                    style="text-decoration: none;">Register</a></span></p>
                                                    <p class="message">Forgot Password? <span><a href="forgotpassword1"
