...
<body>
        ...
        <header class="header">
            ...
            <ul>
                ...
                <li> <a href="fieldofficerregister"> Sign up </a>
                </li>
                <li> <a href="fieldofficerlogin"> Sign in </a>
                </li>
            </ul>
        </header>
                            ...
                            <c:choose>
                                ...
                                <c:when test="${mode=='mode_fieldofficerregister'}">
                                    <form action="fieldofficersave-user" class="register-form" method="POST">
                                        ...
                                        <div class="alignment">
                                            <input type="hidden" value="FieldOfficer" name="category"
                                                path="${user.category}" />
                                        ...
                                        <div class="alignment">
                                            ...
                                            <input type="password" class="input-icon" id="pass_log_id"
                                        ...
                                        <div class="alignment">
                                            ...
                                            <input type="text" name="lastname" path="${user.lastname}"
                                                class="input-icon" placeholder="&#xf007;    Last Name" />
                                        </div>
                                        ...
                                        <div class="alignment">
                                            <input placeholder="Date of Birth" class="input-icon" class="textbox-n"
                                                ...
                                                id="date" />
                                            <label for="Gender" class="input-icon">Gender:</label>
                                        ...
                                        <div class="alignment">
                                            <input type="text" path="${user.mblnumber}" class="input-icon" id="phone"
                                                name="mblnumber" placeholder="&#xf095;    9876543210"
                                                pattern="[1-9]{1}[0-9]{9}" required>

                                            <input type="email" path="${user.email}" class="input-icon"
                                                placeholder="&#xf0e0;    Work email" name="email" required>
                                        </div>
                                        
                                        <div class="alignment">
                                            <select id="designation" class="input-icon" name="designation"
                                                path="${user.designation}" required>
                                            ...
                                            <select id="role" class="input-icon" path="${user.role}" name="role"
                                                required>
                                                <option value="" disabled selected>Role</option>
                                                <option value="Processing Officer">Processing Officer</option>
                                                <option value="Internal Auditor">Internal Auditor</option>
                                                <option value="Marketing Representative">Marketing Representative
                                                </option>
                                        ...
                                        <input type="submit" name="submit" class="sub sub btn btn-success btn-block mb-2" value="Get started now">
                                        <p class="message">Existing User? <span><a href="fieldofficerlogin"
                                                    style="text-decoration: none;">Log
                                                    in</a></span></p>
                                    </form>
                                </c:when>
                                ...
                                <c:when test="${mode=='mode_fieldofficerregistered'}">
                                    <h3>Your Field Officer Registration was succesfully Completed</h3>
                                ...
                                <c:when test="${mode=='mode_fieldofficerlogin'}">
                                    <form action="fieldofficerloginuser" method="POST">
                                        ...
                                        <input type="submit" name="submit" class="sub btn btn-success mb-3"
                                            value="Log in">
                                        <p class="message">Not Registered? <span><a href="fieldofficerregister"
                                                    style="text-decoration: none;">Register</a></span></p>
                                                    <p class="message">Forgot Password? <span><a href="fieldforgotpassword1"
                        style="text-decoration: none;">Click Here</a></span></p>
                                    </form>
                                </c:when>
                                 <c:when test="${mode=='forgotpassword'}">
    <form action="fieldupdatepassword" method="POST">
        ...
        <div class="alignment">
            ...
            placeholder="&#xf095;    Phone Number" pattern="[1-9]{1}[0-9]{9}" name="mblnumber"
                path="${user.mblnumber}" required>
        </div>

        <input type="text" class="input-icon" placeholder="&#xf0e0;    Email Id"
            name="email" path="${user.email }" style="width: 100%;" required>
